...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='/content/person_retrieval/configs/retrieval_flickr.yaml')
    parser.add_argument('--output_dir', default='/content/person_retrieval/output/Retrieval_flickr')
